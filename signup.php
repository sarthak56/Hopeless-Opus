	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="include_tt/signup.inc.php" method="POST">
					<span class="login100-form-title p-b-59">
						Sign Up
					</span>
					<div class="wrap-input100 validate-input" data-validate="Name is required" class="signup-form" action="include_tt/signup.inc.php" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Registration Number is required">
						...
						<input class="input100" type="number" name="regno" placeholder="Registration Number...">
						<span class="focus-input100"></span>
					</div>
